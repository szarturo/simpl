...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW V_SIM_TABLA_AMORT_CONCEPTO ("CVE_GPO_EMPRESA", "CVE_EMPRESA", "ID_PRESTAMO", "NUM_PAGO_AMORTIZACION", "FECHA_AMORTIZACION", "ID_ACCESORIO", "IMP_NETO", "IMP_ORIGINAL", "IMP_EXTRAORDINARIO", "IMP_PAGADO", "CVE_CONCEPTO") AS 
